...
//Date Layer Constants
#define DATE_FONT_SIZE 21
#define DATE_LAYER_WIDTH SCREEN_WIDTH - 48
#define DATE_LAYER_HEIGHT BATTERY_ICON_SIZE + PADDING_Y
#define DATE_LAYER_POS_X 0
#define DATE_LAYER_POS_Y 0
